...
function newn() {
  ...
  let html = document.getElementById("instruments").innerHTML;
  console.log(html)
  document.getElementById("instruments").innerHTML = html + `<br><span id="Note${number}"><select name="Instrument${number}" id="Instrument${number}">
